...
var ProtectedListPage = (0, import_react.lazy)(
  () => import("./index-CGmh3cED-N7YKXYTN.js").then((mod) => ({ default: mod.ProtectedListPage }))
);
var ProtectedEditPage = (0, import_react.lazy)(
  () => import("./id-CtcCl3zh-4ZJNBNA3.js").then((mod) => ({ default: mod.ProtectedEditPage }))
);
var routes = [
  {
    path: "/",
...
//# sourceMappingURL=router-Cr3nulh9-I7YF65XE.js.map
